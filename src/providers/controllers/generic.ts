...
providerMap['oai_dc']        = new CoreOaiProvider(factory, new Configuration(), new ScicatDcMapper());
providerMap['panosc']        = new CoreOaiProvider(factory, new Configuration(), new ScicatPanoscMapper());
providerMap['oai_datacite' ] = new CoreOaiProvider(factory, new Configuration(), new OpenaireMapper());
...
export let oai = (req: Request, res: Response) => {
  ...
  let providerName : any = req.query.metadataPrefix;
  providerName = providerName ? providerName : 'oai_dc' ; 
  logger.debug("Request Verb:"+req.query.verb+"; Format: "+providerName);
